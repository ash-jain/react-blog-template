...
function Navbar() {
    return (
        <nav className="navbar">
            ...
            <button className="hamburger-open-btn" onClick={ openHamburger }><i class="fas fa-bars"></i></button>

            <div className="hamburger-menu">
                <div className="hamburger-left">
                    <div className="hamburger-close-btn" onClick={ closeHamburger}><i class="fas fa-times"></i></div>
                </div>
